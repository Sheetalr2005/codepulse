...
import { Activity, Trophy, Star, Flame, BarChart3 } from "lucide-react";
...
function Analytics() {
  ...
  problems.forEach((problem) => {
    if (problem.solvedDate) {
      ...
      solveCountMap[key] = (solveCountMap[key] || 0) + 1;
    }
  });
          ...
          <div className="relative z-10 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-white/10 bg-white/[0.03] mb-7">
                ...
                <span className="text-gray-300 text-sm">Advanced Coding Analytics</span>
              </div>
            ...
            <div className="relative w-[220px] h-[220px] flex items-center justify-center mx-auto xl:mx-0">
              ...
              <svg className="absolute inset-0 -rotate-90" viewBox="0 0 220 220">
                ...
                <motion.circle
                  ...
                  animate={{
                    strokeDashoffset: 578 - (578 * successRate) / 100,
                  }}
                  transition={{
                    duration: 1.5,
                  }}
              ...
              <div className="relative z-10 text-center">
                <p className="text-gray-400 text-sm mb-2">Interview Readiness</p>

                <h1 className="text-5xl font-black">{successRate}%</h1>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1.5fr_0.7fr] gap-6">
          ...
          <Card className="rounded-[30px] border border-white/10 bg-[#0f172a]/80 p-6 backdrop-blur-xl">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-2xl font-bold">Submission Heatmap</h2>

                <p className="text-gray-400 text-sm mt-1">Your coding activity</p>
              </div>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="grid grid-flow-col grid-rows-7 gap-2">
                    {dates.map((date, index) => {
                      ...
                      return <div key={index} className={`w-4 h-4 rounded-[4px] ${bg}`}></div>;
                    })}
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="rounded-[30px] border border-white/10 bg-[#0f172a]/80 p-6 backdrop-blur-xl">
              <div className="flex items-center justify-between mb-5">
                <div>
                  <h2 className="text-2xl font-bold">Difficulty Breakdown</h2>

                  <p className="text-gray-400 text-sm mt-1">Problem distribution</p>
                </div>
              ...
              <div className="h-[260px]">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie data={difficultyData} dataKey="value" innerRadius={65} outerRadius={100}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="rounded-[24px] border border-white/10 bg-[#0f172a]/80 p-5 backdrop-blur-xl">
                ...
                <h1 className="text-4xl font-black text-orange-400 mt-2">{currentStreak}</h1>

                <p className="text-gray-500 text-xs mt-2">Keep the streak alive 🔥</p>
              </Card>
              ...
              <Card className="rounded-[24px] border border-white/10 bg-[#0f172a]/80 p-5 backdrop-blur-xl">
                ...
                <h1 className="text-4xl font-black text-purple-400 mt-2">{bestStreak}</h1>

                <p className="text-gray-500 text-xs mt-2">Personal best consistency</p>
              </Card>
            </div>
          </div>
        </div>
