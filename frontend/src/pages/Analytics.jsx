            ...
            <div className="flex justify-center mt-12">
              <div
                ...
                style={{
                  ...
                  #22c55e 0deg ${
                    (easyProblems / Math.max(totalProblems, 1)) *
                    360
                  }deg,
                  #facc15 ${
                    (easyProblems /
                      Math.max(totalProblems, 1)) *
                    360
                  }deg ${
                    ((easyProblems +
                      mediumProblems) /
          ...
          <div className="xl:col-span-2 bg-[#0f172a]/80 backdrop-blur-xl border border-white/10 rounded-[32px] p-8">
            ...
            {topicCounts.length > 0 ? (
              ...
              <div className="text-center py-14">
                ...
                <p className="text-gray-400 mt-3">
                  Add problems to generate topic
                  analytics.
                </p>
              </div>
            )}
            ...
            <div className="space-y-5">
              <div className="bg-[#111827]/70 border border-white/5 rounded-3xl p-5">
                ...
                <p className="text-gray-400 mt-3 leading-relaxed">
                  Medium difficulty problems improve
                  interview readiness the fastest.
                </p>
              </div>
              ...
              <div className="bg-[#111827]/70 border border-white/5 rounded-3xl p-5">
                ...
                <p className="text-gray-400 mt-3 leading-relaxed">
                  Solving one problem daily builds
                  long-term interview confidence.
                </p>
              </div>
              ...
              <div className="bg-[#111827]/70 border border-white/5 rounded-3xl p-5">
                ...
                <p className="text-gray-400 mt-3 leading-relaxed">
                  Revision improves retention and
                  coding speed during interviews.
                </p>
              </div>
            </div>
          </div>
